...
class EmailService {
    ...
    getVerificationEmailTemplate(userName, verificationUrl) {
        ...
        <head>
            ...
            <title>Verify Your Account - Central Trade Hub</title>
            <style>
                body { 
        ...
        <body>
            <div class="container">
                <div class="header">
                    <div class="logo">🏦 Central Trade Hub</div>
                    <h1>Verify Your Email Address</h1>
                    <p>Welcome to professional trading</p>
                </div>
                <div class="content">
                    <h2>Hello ${userName},</h2>
                    <p>Thank you for registering with Central Trade Hub! To complete your account setup and ensure the security of your trading account, please verify your email address.</p>
                    ...
                    <p>Best regards,<br>
                    <strong>Central Trade Hub Support Team</strong><br>
                    support@centraltradehub.com</p>
                </div>
                <div class="footer">
                    ...
                    <p>If you have questions, contact us at <strong>support@centraltradehub.com</strong></p>
                </div>
            </div>
        </body>
        </html>
