...
class AISupportChat {
    ...
    addWelcomeMessage() {
        setTimeout(() => {
            this.addMessage(
                "👋 Welcome to Central Trade Hub! I'm your AI support assistant. I can help you with registration, login issues, wallet connections, deposits, trading, and more. How can I assist you today?",
                'ai'
            );
        }, 500);
    }
